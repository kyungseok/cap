...
with tab1:
    ...
    with info_col1:
        ...
        part_number = st.text_input("P/N (품명)", value="CMPCAP-0.07-F3-GD2-PP")

        option_list = ["C1, F2 (F6)", "C1, F3 (F9)", "C1, NPT (N6)", "C1, SW (S6)", "C1, P6", "C2, CL", "C2, F9", "C2, FE", "C3, A1", "C3, B2", "-"]
        product_option = st.selectbox("옵션", option_list, index=10)
    ...
    dimension_defaults = {
        "길이 치수": {"spec": "143.3", "tol": "0.5"},
        "외경 치수 (OD)": {"spec": "67.4", "tol": "0.5"},
        "Inlet/outlet OD": {"spec": "10.5", "tol": "0.2"},
        "Inlet/outlet 나사선 OD": {"spec": "15.4", "tol": "0.1"},
        "내경 치수 (ID)": {"spec": "", "tol": ""},
        "Vent OD": {"spec": "", "tol": ""},
        "나사선 OD": {"spec": "", "tol": ""},
        "실링 오링 OD": {"spec": "", "tol": ""},
        "In/Outlet 오링 홈간 거리": {"spec": "", "tol": ""},
    }
    sample_count = 5
